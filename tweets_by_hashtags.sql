...
BEGIN
	...
	/* if the lastchar is an 'a' this tweet may be trying to change the original author to the referenced tweet, so match up the id's referenced */
	UPDATE tweet SET id_twitter_referenced=NULL WHERE id_twitter_referenced='' AND `id_process`=@id_process;
	UPDATE tweet JOIN tweet AS tweet_referenced ON tweet.id_twitter_referenced=tweet_referenced.id_twitter SET tweet.id_tweet_referenced=tweet_referenced.id_tweet WHERE tweet.lastchar='a' AND `tweet`.`id_process`=@id_process;
	...
	INSERT INTO `tweet_tmp` (`id_tweet`,`id_tweet_referenced`,`id_hashtag`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar` ) SELECT `id_tweet`,`id_tweet_referenced`,`id_hashtag1`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar`  FROM `tweet` WHERE `tweet`.`id_process`=@id_process AND `id_hashtag1` IS NOT NULL;
	INSERT INTO `tweet_tmp` (`id_tweet`,`id_tweet_referenced`,`id_hashtag`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar` ) SELECT `id_tweet`,`id_tweet_referenced`,`id_hashtag2`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar`  FROM `tweet` WHERE `tweet`.`id_process`=@id_process AND `id_hashtag2` IS NOT NULL;
	INSERT INTO `tweet_tmp` (`id_tweet`,`id_tweet_referenced`,`id_hashtag`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar` ) SELECT `id_tweet`,`id_tweet_referenced`,`id_hashtag3`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar`  FROM `tweet` WHERE `tweet`.`id_process`=@id_process AND `id_hashtag3` IS NOT NULL;
	INSERT INTO `tweet_tmp` (`id_tweet`,`id_tweet_referenced`,`id_hashtag`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar` ) SELECT `id_tweet`,`id_tweet_referenced`,`id_hashtag4`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar`  FROM `tweet` WHERE `tweet`.`id_process`=@id_process AND `id_hashtag4` IS NOT NULL;
	INSERT INTO `tweet_tmp` (`id_tweet`,`id_tweet_referenced`,`id_hashtag`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar` ) SELECT `id_tweet`,`id_tweet_referenced`,`id_hashtag5`,`id_twitter`,`author_id`,`author_username`,`created_ts`,`currency`,`amount`,`is_bid`, `lastchar`  FROM `tweet` WHERE `tweet`.`id_process`=@id_process AND `id_hashtag5` IS NOT NULL;
